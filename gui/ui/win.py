...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.data_output = QtWidgets.QPushButton(self.groupBox_2)
        self.data_output.setObjectName("data_output")
        self.gridLayout.addWidget(self.data_output, 15, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.data_output.setText(_translate("MainWindow", "数据导出"))
